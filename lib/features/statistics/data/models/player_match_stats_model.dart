import '../../../matches/domain/entities/player_match_stats.dart';

/// Statistics-feature DTO for a player's aggregated box-score line.
///
/// Equivalent to the matches-feature `PlayerMatchStatsModel`, provided so the
/// statistics feature can parse player stats without depending on the matches
/// data layer. Maps to the shared [PlayerMatchStats] domain entity.
